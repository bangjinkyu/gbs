...
public class FirstFragment extends Fragment {
    ...
    private LinearLayout conTab1;
    private String urlGetSunday = "http://www.bwm.or.kr/attend/m_attend_holyday_g.php?day=";
    ...
    protected Dialog onCreateDialog(int paramInt) {
        return new DatePickerDialog(mContext, mSundaySetListener,mYear_S,mMonth_S, mDay_S);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        conTab1 = (LinearLayout)view.findViewById(R.id.conTab1);
